...
The older `notebook_complete_with_setup_code.ipynb` and Parts 4/5/9/11 of `docs/` document optional advanced Oracle capabilities such as MLE and JSON Relational Duality Views. They remain useful reference material, but are intentionally outside the current AppBook's nine live chapters.
