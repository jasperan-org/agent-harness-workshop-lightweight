...
If you want to see *how* the Oracle setup was done, read `app/scripts/bootstrap.py` or open `notebook_complete_with_setup_code.ipynb` — the full source that includes every DDL.
